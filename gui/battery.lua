...
local shutdown_popup = require("gui.logout_menu_widget")
...
local ASSET_DIR = HOME .. '/.config/awesome/gui/images'
...
local function worker(user_args)
    ...
    local warning_msg_icon = args.warning_msg_icon or ASSET_DIR .. '/spaceman.jpg'
    ...
    if display_notification then
        ...
        battery_widget:connect_signal("mouse::leave", function()
            naughty.destroy(notification)
            battery_widget:disconnect_signal("mouse::leave", function()  end)
        end)
