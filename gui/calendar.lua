...
local weather = require("gui.weather")
...
local function worker(user_args)
    ...
    local calendar_themes = {
        ...
        dark = {
            bg = '#222222',
            fg = '#aaaaaa',
            focus_date_bg = '#444444',
            focus_date_fg = '#aaaaaa',
            weekend_day_bg = '#222222',
            weekday_fg = '#aaaaaa',
            header_fg = '#aaaaaa',
            border = '#222222'
        },
    ...
    text_widget:set_markup("<span font='DejaVu Sans 10'>" .. config.location .. "</span>")
    local margin_text_widget = wibox.container.margin(text_widget, 0, 0, 0, 5)

    local weather_widget = weather.update_weather_info()

    local layout = wibox.layout.fixed.vertical()
    layout:add(cal)
    layout:add(wibox.container.place(margin_text_widget, "center"))
    layout:add(weather_widget)
    ...
    function calendar_widget.toggle()
        ...
        if popup.visible then
            ...
            elseif placement == 'top_right' then
                awful.placement.top_right(popup, { margins = { top = 24, right = 0}, parent = awful.screen.focused() })
